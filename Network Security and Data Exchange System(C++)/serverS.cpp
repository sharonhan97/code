...
int main() {    
    ...
    cout<<"ServerS is up and running using UDP on port 41328."<<"\n";
    ...
    while(true){
        ...
        //if user is student 
        if (user=="S"){
            cout<<"ServerS received "<<code<<" code from the Main Server."<<endl;    
            ...
            cout<<"ServerS finished sending the availability status of code "<< code<<" to the Main Server using UDP on port "<<MYPORT<<"."<<endl;          
        }
        //if user is admin
        else if(user=="A"){
            cout<<"ServerS received an inventory status request for code "<<code<<"."<<endl;
            ...
            cout<<"ServerS finished sending the inventory status to the Main server using UDP on port  "<<MYPORT<<"."<<endl;
        }
